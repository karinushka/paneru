...
use objc2_app_kit::{
    ...
    NSDeviceRGBColorSpace, NSFont, NSImage, NSImageScaling, NSImageView,
    NSLayoutAttribute, NSMenu, NSMenuItem, NSScreen, NSStackView, NSStatusBar, NSStatusItem,
...
impl MenuBarManager {
    ...
    fn gradient_view(
        ...
        if gradient.len() < 1 || size.width <= 0.0 || size.height <= 0.0 {
            return None;
        }
